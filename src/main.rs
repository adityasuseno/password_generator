...
fn main() {
    loop {
        ...
        let answer = Question::new("Do you want to include lower case characters?")
            .default(Answer::YES)
            .show_defaults()
            .confirm();
        ...
        let answer = Question::new("Do you want to include upper case characters?")
            .default(Answer::YES)
            .show_defaults()
            .confirm();
        if answer == Answer::YES {
        ...
        let answer = Question::new("Do you want to include numbers?")
            .default(Answer::YES)
            .show_defaults()
            .confirm();
        if answer == Answer::YES {
        ...
        let answer = Question::new("Do you want to add special characters?")
            .default(Answer::YES)
            .show_defaults()
            .confirm();
        if answer == Answer::YES {
        ...
        let p = PasswordGenerator::new()
            .length(password_length.into())
            .numbers(use_numbers)
            .lowercase_letters(use_lowercase)
            .uppercase_letters(use_uppercase)
            .symbols(use_symbols)
            .spaces(false)
